...
import { Plus, Search, Filter, TrendingUp, Sparkles, Crown, Zap } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row gap-6 mb-12">
        <div className="flex-1">
          <Input
            ...
            className="text-lg py-4 rounded-2xl shadow-lg border-2 focus:border-indigo-400"
          />
        </div>
        <div className="relative">
          <select
            ...
            className="pl-12 pr-8 py-4 border-2 border-gray-300 rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-white shadow-lg text-lg font-medium"
          >
