      ...
      <div className="p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                {theme.duality[0]} vs {theme.duality[1]}
              </p>
            </div>
          </div>
          <span className={`px-2 py-1 rounded-full text-xs font-medium ${
            ...
            {theme.isActive ? 'Active' : 'Completed'}
          </span>
        </div>
        ...
        <div className="flex items-center justify-between text-sm text-gray-500 mb-6">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-1">
              ...
              <span>{theme.participants} poets</span>
            </div>
            <div className="flex items-center space-x-1">
              <FileText className="h-4 w-4" />
              <span>{theme.totalPoems} poems</span>
            </div>
          </div>
          <div className="flex items-center space-x-1">
            <Clock className="h-4 w-4" />
            <span>{formatTimeRemaining(theme.endDate)}</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          >
            {theme.isActive ? 'Join Battle' : 'View Results'}
          </button>
        </div>
      </div>
    </div>
